...
export type CollectionItemFragment = {
	...
	image: { url: string; size?: number | null; width?: number | null; height?: number | null };
};
...
export type CollectionsListFragmentFragment = {
	id: string;
	name: string;
	description?: string | null;
	slug: string;
...
export type ProductsGetListPageQuery = {
	products: Array<{
		id: string;
		name: string;
		description: string;
...
export type ProductVariantBySizeAndColorQuery = {
	product?: { name: string; id: string } | null;
	productColorVariants: Array<{ color: ProductColor; name: string; id: string }>;
	productSizeColorVariants: Array<{
		color: ProductColor;
		size: ProductSize;
		name: string;
		id: string;
...
) as unknown as TypedDocumentString<CollectionItemFragment, unknown>;
export const CollectionsListFragmentFragmentDoc = new TypedDocumentString(
  ...
  image {
    ...
    `,
	{ fragmentName: "CollectionsListFragment" },
) as unknown as TypedDocumentString<CollectionsListFragmentFragment, unknown>;
...
export const ProductVariantBySizeAndColorDocument = new TypedDocumentString(`
  ...
  productSizeColorVariants {
	...
	ProductVariantBySizeAndColorQuery,
	ProductVariantBySizeAndColorQueryVariables
>;
...
fragment ProductListItem on Product {
  ...
  price
	...
	ProductsGetByCollectionQuery,
	ProductsGetByCollectionQueryVariables
>;
