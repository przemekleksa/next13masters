...
export function graphql(
	source: "fragment CollectionItem on Collection {\n  name\n  description\n  products {\n    ...ProductListItem\n    collections {\n      name\n    }\n  }\n  image {\n    url\n    size\n    width\n    height\n  }\n}",
): typeof import("./graphql").CollectionItemFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query CollectionsList {\n  collections {\n    ...CollectionsListFragment\n  }\n}",
): typeof import("./graphql").CollectionsListDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment CollectionsListFragment on Collection {\n  id\n  name\n  description\n  slug\n  image {\n    url\n    size\n    width\n    height\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsGetListPage($skip: Int!) {\n  products(skip: $skip, first: 2) {\n    ...ProductListItem\n  }\n}",
): typeof import("./graphql").ProductsGetListPageDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductVariantBySizeAndColor($id: ID!) {\n  product(where: {id: $id}) {\n    name\n    id\n  }\n  productColorVariants {\n    color\n    name\n    id\n  }\n  productSizeColorVariants {\n    color\n    size\n    name\n    id\n  }\n}",
): typeof import("./graphql").ProductVariantBySizeAndColorDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment ProductListFragment on Query {\n  products(first: 20) {\n    ...ProductListItem\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsGetByCollection($slug: String!) {\n  collections(where: {slug: $slug}) {\n    ...CollectionItem\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsSearchList($searchTerm: String!) {\n  products(where: {name_contains: $searchTerm}) {\n    ...ProductListItem\n  }\n}",
